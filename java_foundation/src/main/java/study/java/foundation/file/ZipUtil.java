...
public class ZipUtil {
    ...
    public static void main(String[] args) throws Exception {  
        String path = System.getProperty("user.dir") + File.separator + "/src/main/java/study/java/foundation/io/";  //源文件路径  
        zip(new File(path+"ZipUtil.java"), new File(System.getProperty("user.dir")+ File.separator + "temp/ZipUtil.zip"));  //压缩文件  
        unzip(path+".zip", System.getProperty("user.dir") + File.separator + "temp"); //解压        
    }  
}
